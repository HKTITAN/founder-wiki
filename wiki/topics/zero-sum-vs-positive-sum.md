...
aliases: ["zero-sum games", "positive-sum games", "game theory startups", "building vs gambling", "startup ethics", "creating value"]
related: ["[[Founder Mindset]]", "[[Convincing Investors]]", "[[Dalton Caldwell]]", "[[Michael Seibel]]"]
sources: ["Ib-dalton-michael-what-basic-game-theory-teaches-us-about-startups"]
speakers_referenced: ["Dalton Caldwell", "Michael Seibel"]
---

# Zero-Sum vs. Positive-Sum Games

[[Dalton Caldwell]] and [[Michael Seibel]] apply basic game theory to startup decision-making, arguing that founders must choose between zero-sum activities (where your gain comes directly from someone else's loss) and positive-sum activities (where value is created that did not exist before) [1]. The framework applies not just to business models but to how founders think about motivation, legacy, and economic downturns.
...
Gambling is the textbook zero-sum game. Poker, sports betting, and financial speculation all share the same structure: "In order for me to win, you have to lose" [1].

Caldwell argues gambling exploits an evolutionary flaw: the brain rewards disproportionate wins without proportionate effort. "If you can somehow windfall into a dead buffalo and you didn't have to risk your life killing it -- that's huge. Unfortunately in today's age it tends to happen in ways that aren't as good" [1].

The skills that make someone good at poker -- bluffing, manipulating others into bad decisions -- transfer easily to "confidence games" outside of poker, both legal and illegal [1].
...
## FOMO and the Sports Gambler Problem

Seibel describes a friend who was a sports gambler: "He would always tell me when he won that weekend and bring stacks of cash. The weekends he didn't win he was just silent." The analogy to startup FOMO: people see others appearing to win at zero-sum games and feel they are missing out. The antidote: "Look a little closer and ask, are those people actually cashing out? Are those people actually doing something sustainable?" [1].

## The Positive Feedback Loop

Positive-sum game players who fail still learn something: "They almost always took something from that game with them that made them better off even if they didn't win." Zero-sum game players who do not cash out have nothing: "The only win is getting out of the game" [1]. There are no incremental lessons in zero-sum games -- "the lesson just comes fast and hard at the end. It's like, and then you're blown up" [1].

## References

1. [Dalton & Michael: What Basic Game Theory Teaches Us About Startups](https://ycombinator.com/library/Ib-dalton-michael-what-basic-game-theory-teaches-us-about-startups) — [[Dalton Caldwell]], [[Michael Seibel]] (2022)
