---
id: 91-why-smart-people-have-bad-ideas
...
hard *sell*; we soon sank to building sites for free, and it was hard to convince galleries even to do that.
...
each point (a day, a week, a month) feel you've put so much time into it that this must be *the* idea.
...
called that. We were so attached to our name that we offered him *5% of the company* if he'd let us have it. But he
...
biggest problem. Most of the groups applying have not stopped to ask: of all the things we could do, is *this* the one
...
Reading the *Wall Street Journal* for a week should give anyone ideas for two or three new startups. The articles are
...
> 80% of MIT spinoffs succeed *provided* they have at least one management person in the team at the start. The business
...
can write an optimizing compiler can design a UI that doesn't confuse users, once they *choose* to focus on that
